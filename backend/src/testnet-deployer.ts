...
// Deploy top N pools
export async function deployTopPools(count: number = 10) {
    ...
    const deployedPools: DeployedPool[] = [];
    const deployedTokens: Map<string, DeployedToken> = new Map();
    ...
    for (let i = 0; i < topPools.length; i++) {
        ...
        try {
            ...
            let assetA: StellarSDK.Asset;
            let assetB: StellarSDK.Asset;
